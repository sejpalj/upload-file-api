...
public class FileSystemStorageServiceTest {
	...
	public void saveNotPermitted() {
		service.store(new MockMultipartFile("abc", "/abc.txt", MediaType.TEXT_PLAIN_VALUE, "Test".getBytes()));
	}

	@Test
	public void savePermitted() {
		service.store(new MockMultipartFile("abc", "abc.txt", MediaType.TEXT_PLAIN_VALUE, "abc".getBytes()));
	}
}
